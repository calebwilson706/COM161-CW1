...
from Outputs.WhileLoopSpecific.OutputDifferenceBetweenMinAndMaxNaturalNumbersInList \
...
class LoopType(Enum):
    ...
    def report_selection(self):
        print("\nYou choose a '", self.get_display_name(), "' loop", sep="")
    ...
    def output_statistics(self, generated_list):
        ...
        if self == LoopType.FOR:
            ...
            output_difference_between_min_and_max_natural_numbers_in_list(generated_list)
